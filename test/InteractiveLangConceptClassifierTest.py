...
class InteractiveLangConceptClassifierTest(OpenRTM_aist.DataFlowComponentBase):
	...
	def __init__(self, manager):
		...
		"""
		"""
		self._SpeechManageProvider = OpenRTM_aist.CorbaConsumer(interfaceType=Manage.SpeechManage)
		"""
		"""
		self._InteractiveManageProvider = OpenRTM_aist.CorbaConsumer(interfaceType=Manage.InteractiveManage)
	...
	def onInitialize(self):
		...
		self._speechmanagePort.registerConsumer("SpeechManage", "Manage::SpeechManage", self._SpeechManageProvider)
		self._interactivemanagePort.registerConsumer("InteractiveManage", "Manage::InteractiveManage", self._InteractiveManageProvider)
